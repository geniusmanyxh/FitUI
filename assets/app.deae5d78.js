import{d as K,h as C,x as ie,o as z,c as M,k as B,H as oe,w as X,n as ve,t as J,e as ue,T as le,_ as ce,a2 as be,E as ye,b as N,r as ae,a3 as _e,a4 as we,J as xe,N as Fe,C as Ae,W as ke,X as I,s as Y,a5 as Se,a6 as Ee,a7 as $e,a8 as Pe,a9 as ze,aa as Ce,ab as De,ac as Te,ad as Ie,ae as Le,u as Oe,j as Re,y as je,af as Me,ag as Be,ah as He,ai as We}from"./chunks/framework.e3af8ae4.js";import{t as Ge}from"./chunks/theme.c09768bb.js";import{B as Ve,F as Ue,a as qe,w as Ze}from"./chunks/clipboard-polyfill.es6.21640ae8.js";const Ne=[Ve,Ue,qe],Xe=l=>{Ne.forEach(p=>l.use(p))},Je={install:Xe};const Ye=`<template>\r
  <div>\r
...
`),d.hasAttribute("data-start")||d.setAttribute("data-start",String(o+1))}b.textContent=s,t.highlightElement(b)},function(s){d.setAttribute(i,E),b.textContent=s})}}),t.plugins.fileHighlight={highlight:function(d){for(var b=(d||document).querySelectorAll(D),n=0,e;e=b[n++];)t.highlightElement(e)}};var T=!1;t.fileHighlight=function(){T||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),T=!0),t.plugins.fileHighlight.highlight.apply(this,arguments)}}()})(pe);var rn=pe.exports;const se=an(rn),sn={vue:"html",html:"html",js:"javascript",ts:"typescript"};function on(l,p){const t=sn[p],c=se.languages[t];if(!t||!c)return console.warn(`Prism does not support the language '${p}'.`),l;const f=se.highlight(l,c,p);return`<pre class="language-${p}"><code >${f}</code></pre>`}const un={class:"source-code-box"},ln=["innerHTML"],cn=K({__name:"showSourceCode",props:{filePath:{default:"../../../examples/button/index.vue"},lang:{default:"html"}},setup(l){const p=Object.assign({"../../../examples/button/button_icon.vue":Ye,"../../../examples/button/button_size.vue":Ke,"../../../examples/button/index.vue":Qe,"../../../examples/button/round.vue":en,"../../../examples/icon/icon_size.vue":nn,"../../../examples/icon/index.vue":tn}),t=l,c=C(""),f=C(!1),m=C("复制失败!"),_=async()=>{try{await Ze(p[t.filePath]),m.value="复制成功!",f.value=!0}catch{m.value="复制失败!",f.value=!1}finally{setTimeout(()=>{f.value=!1},2e3)}};return ie(()=>t.filePath,i=>{i&&(c.value=on(p[i],t.lang))},{immediate:!0,deep:!0}),(i,y)=>(z(),M("div",un,[B("div",{innerHTML:c.value},null,8,ln),B("div",{class:"copy-code",onClick:_},"复制"),oe(le,null,{default:X(()=>[f.value?(z(),M("div",{key:0,class:ve(["copy-code-tip",f.value?"":"fail"])},J(m.value),3)):ue("",!0)]),_:1})]))}});const pn=ce(cn,[["__scopeId","data-v-19a93a37"]]),gn={class:"showDemo"},fn={key:0,class:"show-desc"},dn={key:2,class:"show-components"},hn=K({__name:"index",props:{rootPath:{default:"../../../examples"},filePath:{default:"button/index.vue"},desc:{default:null},lang:{default:"vue"}},setup(l){const p=l,t=be(),c=C(t.default!==void 0),f=C(t.desc!==void 0),m=Object.assign({"../../../examples/button/button_icon.vue":()=>I(()=>import("./chunks/button_icon.9c420680.js"),["assets/chunks/button_icon.9c420680.js","assets/chunks/clipboard-polyfill.es6.21640ae8.js","assets/chunks/framework.e3af8ae4.js"]),"../../../examples/button/button_size.vue":()=>I(()=>import("./chunks/button_size.0cba6cfe.js"),["assets/chunks/button_size.0cba6cfe.js","assets/chunks/clipboard-polyfill.es6.21640ae8.js","assets/chunks/framework.e3af8ae4.js"]),"../../../examples/button/index.vue":()=>I(()=>import("./chunks/index.509e23ec.js"),["assets/chunks/index.509e23ec.js","assets/chunks/clipboard-polyfill.es6.21640ae8.js","assets/chunks/framework.e3af8ae4.js"]),"../../../examples/button/round.vue":()=>I(()=>import("./chunks/round.9edc82a6.js"),["assets/chunks/round.9edc82a6.js","assets/chunks/clipboard-polyfill.es6.21640ae8.js","assets/chunks/framework.e3af8ae4.js"]),"../../../examples/icon/icon_size.vue":()=>I(()=>import("./chunks/icon_size.42aa0292.js"),["assets/chunks/icon_size.42aa0292.js","assets/chunks/clipboard-polyfill.es6.21640ae8.js","assets/chunks/framework.e3af8ae4.js"]),"../../../examples/icon/index.vue":()=>I(()=>import("./chunks/index.e99e0776.js"),["assets/chunks/index.e99e0776.js","assets/chunks/clipboard-polyfill.es6.21640ae8.js","assets/chunks/framework.e3af8ae4.js"])}),_=C(`${p.rootPath}/${p.filePath}`),i=ye(),y=async w=>{i.value=ke(m[w])},A=C(!1),E=C("显示代码"),D=()=>{A.value=!A.value,A.value?E.value="隐藏代码":E.value="显示代码"};return ie([()=>p.rootPath,()=>p.filePath,()=>p.desc],([w,L,T])=>{_.value=w+"/"+L,y(_.value)},{immediate:!0,deep:!0}),(w,L)=>{const T=Ae("ClientOnly");return z(),N(T,null,{default:X(()=>[B("div",gn,[f.value?(z(),M("div",fn,[ae(w.$slots,"desc",{},void 0,!0)])):_e((z(),M("div",{key:1,class:"show-desc"},J(w.desc),513)),[[we,w.desc]]),c.value?(z(),M("div",dn,[ae(w.$slots,"default",{},void 0,!0)])):(z(),N(xe(i.value),{key:3})),B("div",{class:"is-show-code",style:Fe({marginBottom:A.value?"-5px":"0px"}),onClick:D},[B("span",null,J(E.value),1)],4),oe(le,null,{default:X(()=>[A.value?(z(),N(pn,{key:0,"file-path":_.value,lang:w.lang},null,8,["file-path","lang"])):ue("",!0)]),_:1})])]),_:3})}}});const mn=ce(hn,[["__scopeId","data-v-dcc06892"]]);const vn={...Ge,enhanceApp({app:l}){l.use(Je),l.component("sdemo",mn)}};function ge(l){if(l.extends){const p=ge(l.extends);return{...p,...l,async enhanceApp(t){p.enhanceApp&&await p.enhanceApp(t),l.enhanceApp&&await l.enhanceApp(t)}}}return l}const R=ge(vn),bn=K({name:"VitePressApp",setup(){const{site:l}=Oe();return Re(()=>{je(()=>{document.documentElement.lang=l.value.lang,document.documentElement.dir=l.value.dir})}),Me(),Be(),He(),R.setup&&R.setup(),()=>We(R.Layout)}});async function yn(){const l=wn(),p=_n();p.provide(Ee,l);const t=$e(l.route);return p.provide(Pe,t),p.component("Content",ze),p.component("ClientOnly",Ce),Object.defineProperties(p.config.globalProperties,{$frontmatter:{get(){return t.frontmatter.value}},$params:{get(){return t.page.value.params}}}),R.enhanceApp&&await R.enhanceApp({app:p,router:l,siteData:De}),{app:p,router:l,data:t}}function _n(){return Te(bn)}function wn(){let l=Y,p;return Ie(t=>{let c=Le(t),f=null;return c&&(l&&(p=c),(l||p===c)&&(c=c.replace(/\.js$/,".lean.js")),f=I(()=>import(c),[])),Y&&(l=!1),f},R.NotFound)}Y&&yn().then(({app:l,router:p,data:t})=>{p.go().then(()=>{Se(p.route,t.site),l.mount("#app")})});export{yn as createApp};
