...
export { default as FScrollbar } from './FScrollbar'
export { default as FBacktop } from './FBacktop'
export { default as FRate } from './FRate'
...
export { FOption, FOptionGroup } from './FSelect'
...
export { default as FSlider } from './FSlider'
...
export { default as FTimeline, FTimelineItem } from './FTimeline'
export { default as FSteps, FStep } from './FSteps'
export { default as FWatermark } from './FWatermark'
...
export { default as FMessageBox } from './FMessageBox'
export { default as FPopconfirm } from './FPopconfirm'
